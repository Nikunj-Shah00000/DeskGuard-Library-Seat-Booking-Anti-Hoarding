  ...
  return (
    ...
    >
      <div className="px-4 md:px-8 lg:px-12 h-14 flex items-center justify-between">
        {/* Brand */}
        <Link href="/library">
          <a className="flex items-center gap-2 group" data-testid="nav-brand">
        ...
        <div className="flex items-center gap-1 overflow-x-auto">
          {navItems.map(({ href, label, icon: Icon }) => {
            ...
            return (
              <Link key={href} href={href}>
                <a
                  className={`flex items-center gap-1.5 px-3 py-1.5 text-[10px] font-700 tracking-[0.12em] uppercase transition-all rounded-sm whitespace-nowrap ${
                    isActive
          ...
          <button
            ...
            className="ml-2 flex items-center gap-1.5 px-3 py-1.5 text-[10px] font-700 tracking-[0.12em] uppercase text-muted-foreground hover:text-destructive hover:bg-destructive/10 transition-all rounded-sm"
